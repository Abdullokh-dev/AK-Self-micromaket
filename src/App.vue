      ...
      <div class="modal-content rounded-4">
        ...
        <div class="modal-body pt-0">
          <form class="was-validated text-center">
            ...
            <div class="px-4 mt-3">
              <input type="text" id="name" placeholder="Name" class="ps-3 form-control" required />
            </div>

            <div class="px-4 mt-3">
              <input type="text" placeholder="Phone" class="ps-3 form-control" required />
            </div>

            <div class="px-4 mt-3">
              <input type="email" placeholder="Email" class="ps-3 form-control" required />
            </div>

            <div class="px-4 mt-3">
              <input type="text" placeholder="Comment" class="ps-3 form-control" required />
            </div>
